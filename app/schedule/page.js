        ...
        <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl flex flex-col space-y-5">
            ...
            <div className="flex items-center">
              ...
              <a href="#instagram" className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white filter hover:brightness-125">
                <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
//     <div className='pb-6'>
//       <NavbarIn />
//       <div className='p-6 px-12 lg:px-36 md:px-24 space-y-12 pt-[32%] lg:pt-[16vh] md:pt-[18vh]  '>

//         <div className='grid grid-cols-1 md:grid-cols-3 gap-6 '>


//           {/* day 1 */}
//           <div className="flex flex-row md:flex-col gap-4 bg-slate-100 p-6 rounded-xl shadow-lg">
//             <div className='text-start'>
//               <h1 className='font-bold text-lg'>Day 01</h1>
//               <h1 className='text-base'>2024 August 03</h1>
//             </div>
//             <a href='/assets/scheduleDay1Aug03Final.pdf' target='_blank' download className='flex items-center gap-2 bg-black text-white p-2 px-4 text-lg font-semibold'> <FiDownload size={25} /> <h1>Download</h1></a>
//           </div>

//           {/* day 2 */}
//           <div className="flex flex-row md:flex-col gap-4 bg-yellow-100 p-6 rounded-xl shadow-lg">
//             <div className='text-start'>
//               <h1 className='font-bold text-lg'>Day 02</h1>
//               <h1 className='text-base'>2024 August 04</h1>
//             </div>
//             <a href='/assets/scheduleDay2Aug04.pdf' download className='flex items-center gap-2 bg-black text-white p-2 px-4 text-lg font-semibold'> <FiDownload size={25} /> <h1>Download</h1></a>
//           </div>

//           {/* day 3 */}
//           {/* <div className="flex flex-row md:flex-col gap-4 bg-slate-100 p-6 rounded-xl shadow-lg">
//       <div className='text-start'>
//           <h1 className='font-bold text-lg'>Day 03</h1>
//           <h1 className='text-base'>2024 August 03</h1>
//         </div>
//         <a href='' download className='flex items-center gap-2 bg-black text-white p-2 px-4 text-lg font-semibold'> <FiDownload size={25}/> <h1>Download</h1></a>
//       </div> */}
//         </div>
//       </div>
//     </div>
