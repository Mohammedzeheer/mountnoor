...
const Footer = () => {
  return (
    <div className="bg-lightYellow pt-44 pb-24 font-rubik shadow-lg">
      <div className="max-w-screen-xl w-full mx-auto  px-12 lg:px-24 md:px-24  grid grid-rows-6 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-12 gap-4">
